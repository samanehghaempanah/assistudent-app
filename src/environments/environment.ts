export const environment = {
  production: false,
  apiUrl: 'https://myapi.behdadeh.ir/api/',
  downloadUrl: 'https://mydownload.iaun.ac.ir/',
  chatApiUrl: 'https://mychat.behdadeh.ir/api/chat/',
  chatHubUrl: 'https://mychat.behdadeh.ir/chatHub',
  
  // apiUrl: 'https://localhost:7137/api/',
  // downloadUrl: 'https://mydownload.iaun.ac.ir/',
  // chatApiUrl: 'https://localhost:7100/api/chat/',
  // chatHubUrl: 'https://localhost:7100/chatHub',
